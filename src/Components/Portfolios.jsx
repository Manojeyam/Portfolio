                    ...
                    >
                        ...
                        <Box>
                            <Box className="lasta" sx={{
                                ...
                                <Box>
                                    <Box component="a" href='https://manojeyam26.artstation.com/' target='blank' sx={{ textDecoration: "none", color: "white", cursor: "pointer" }}><FaArtstation style={{ fontSize: "50px !important" }} /></Box>
                                </Box>
                                <Box>
